...
class TransformersShard:
    ...
    def __init__(self, base_model: PreTrainedModel, shard: Shard):
        ...
        # Note: The TransformersShard wrapper only EXECUTES the assigned layers
        # during forward pass — unused layers are in memory but never run.
        # Proper selective loading (loading only needed weights from checkpoint)
        # requires weight-name remapping and is left as a future optimization.
